...
```text
docker.io/iraccooni/sowhat-task-worker:0.3.7
docker.io/iraccooni/sowhat-task-worker@sha256:6f9b986329e27600b347205dd4bec3aa43f0372ec0965f71d88d2abc774cd628
```

Use the digest form. There is deliberately no `latest` tag. Versions `0.2.0` through `0.3.6` are
superseded.
...
x-task-worker-image: &task-worker-image docker.io/iraccooni/sowhat-task-worker@sha256:6f9b986329e27600b347205dd4bec3aa43f0372ec0965f71d88d2abc774cd628
